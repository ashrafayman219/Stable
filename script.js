...
async function initializeHeatMap() {
  try {
    ...
    let url = "https://services3.arcgis.com/AtFD5NjBs72VpMjN/arcgis/rest/services/Stable/FeatureServer/5";
    const renderer = {
      type: "heatmap",
      colorStops: [
          ...
          content: [
            {
              ...
              fieldInfos: [
                ...
                {
                  fieldName: "رقم_هوية_المراقب",
                  label: "رقم_هوية_المراقب",
                },
                {
                  fieldName: "رقم_الرخصة",
                  label: "رقم_الرخصة",
                },
                {
                  fieldName: "هل_المخالف_معلوم",
                  label: "هل_المخالف_معلوم",
                },
                {
                ...
                {
                  fieldName: "وصف_المخالفة",
                  label: "وصف_المخالفة",
                },
                {
                  fieldName: "قيمة_المخالفات",
                  label: "قيمة_المخالفات",
                },
                {
                  fieldName: "حالة_المخالفة",
                  label: "حالة_المخالفة",
                },
              ],
            },
